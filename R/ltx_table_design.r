#------------------------------------------ ltx_table_design ------------------------------------------
#' Designs a table based on a object returned by the rr_table_prep function
#'
#' This function designs the a latex table based on the data frame list returned by the rr_table_prep function.
#'
...
#'
#' @details This function designs a latex pivot table based on the results of the rr_table_prep output. This means that the function
