...
#'
#' This function designs the a HTML table based on the data frame list returned by the rr_table_prep function.
#'
...
#'
#' @details This function designs a HTML pivot table based on the results of the rr_table_prep output. This means that the function
