...
The Rout package is developed to easily create pdf or html reports including tables, listings and plots created in R. The reporting idea was initiated within the context of clinical research, where listings for pharmacokinetics and safety are generated. The package was set up such that it is generic enough to be used in other fields too.
...
ltx_plot(pl,out="out6.tex",titlepr = "plot A",title="example for basic plotting")
...
You might have noticed that not all output generated has the same layout. This is controlled by the templates,
